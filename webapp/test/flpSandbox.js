		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#z10gerenciarparceiros-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"z10gerenciarparceiros-display": {
								"semanticObject": "z10gerenciarparceiros",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=z10.gerenciarparceiros",
									"url": sap.ui.require.toUrl("z10/gerenciarparceiros")
								}
							}
						}
					}
